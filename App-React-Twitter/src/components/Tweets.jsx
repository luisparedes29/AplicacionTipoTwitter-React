...
function Tweets(props) {
  ...
  return (
    <div className="w-full mb-10 min-h-screen">
      <section className="text-white font-Kanit text-center text-3xl m-5 min-h-screen flex-grow mb-16 flex flex-col items-center sm:mb-20 ">
        ...
        <section className="bg-azulOscuro2 rounded-t-lg w-full h-full sm:w-[60%] ">
          {result &&
            result.map((data) => (
              <CardTweet
                key={data.id}
